...
self.addEventListener('notificationclick', function (event) {
  ...
  if (!event.action) {
    ...
    event.waitUntil(
      clients.openWindow('https://app-wokppl-staging.konbi.cloud/#!inbox-detail?orderNumber=' + id)
    );
  }
  else {
    ...
    switch (event.action) {
      case 'yes':
        event.waitUntil(
          clients.openWindow('https://app-wokppl-staging.konbi.cloud/#!survey?surveyId=' + data.id)
        );
        break;
      default:
        break
